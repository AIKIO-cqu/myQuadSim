...
class Wind:
    ...
    def randomWind(self, t):
        if (self.windType == 'SINE') or (self.windType == 'RANDOMSINE'):
            ...
            velW = self.velW_a1 * sin(self.velW_f1 * t - self.velW_d1) + self.velW_a2 * sin(
                self.velW_f2 * t - self.velW_d2) + self.velW_a3 * sin(self.velW_f3 * t - self.velW_d3) + self.velW_med
            qW1 = self.qW1_a1 * sin(self.qW1_f1 * t - self.qW1_d1) + self.qW1_a2 * sin(
                self.qW1_f2 * t - self.qW1_d2) + self.qW1_med
            qW2 = self.qW2_a1 * sin(self.qW2_f1 * t - self.qW2_d1) + self.qW2_a2 * sin(
                self.qW2_f2 * t - self.qW2_d2) + self.qW2_med
